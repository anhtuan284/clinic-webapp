...
INSERT INTO `appointment` VALUES (1,'2024-04-30','15:30:00',0,0,1,1,2,'2024-05-04 17:19:45','2024-05-04 17:19:45'),(2,'2024-04-30','16:30:00',0,1,1,1,2,'2024-05-04 17:19:45','2024-05-04 17:19:45'),(3,'2024-04-30','08:30:00',0,0,1,1,2,'2024-05-04 17:19:45','2024-05-04 17:19:45'),(4,'2024-04-30','09:30:00',0,0,1,1,2,'2024-05-04 17:19:45','2024-05-04 17:19:45'),(5,'2024-04-30','11:30:00',0,0,1,1,2,'2024-05-04 17:19:45','2024-05-04 17:19:45');
...
INSERT INTO `bill` VALUES (100000.00,120000.00,220000.00,1,1,'2024-05-06 16:43:55','2024-05-06 16:43:55');
...
--
-- Table structure for table `history_online_payment`
--

DROP TABLE IF EXISTS `history_online_payment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `history_online_payment` (
  `id` int NOT NULL AUTO_INCREMENT,
  `amount` decimal(11,2) DEFAULT NULL,
  `response_code` varchar(300) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `history_online_payment_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `history_online_payment`
--

LOCK TABLES `history_online_payment` WRITE;
/*!40000 ALTER TABLE `history_online_payment` DISABLE KEYS */;
/*!40000 ALTER TABLE `history_online_payment` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `medicine` VALUES (1,'Panadol',1000.00,'Uống sau bữa ăn','2025-12-31','2024-05-04 16:54:32','2024-05-06 01:15:26'),(2,'Zinc',2000.00,'Uống trước khi ngủ','2024-06-30','2024-05-04 16:54:32','2024-05-06 01:15:39'),(3,'Vitamin C',3000.00,'Uống trước khi ngủ','2024-06-30','2024-05-04 16:54:32','2024-05-04 16:54:32');
...
INSERT INTO `medicine_category` VALUES (2,1,'2024-05-06 01:15:26','2024-05-06 01:15:26'),(2,2,'2024-05-06 01:15:39','2024-05-06 01:15:39'),(3,2,'2024-05-06 01:15:39','2024-05-06 01:15:39'),(4,2,'2024-05-06 01:15:39','2024-05-06 01:15:39'),(4,3,'2024-05-04 17:02:10','2024-05-04 17:02:10');
...
INSERT INTO `medicine_detail` VALUES (2,'2 lần/ngày, sáng chiều',1,1,4),(1,'2 lần/ngày, sáng chiều',1,2,2),(2,'2 lần/ngày, sáng chiều',1,3,1);
...
INSERT INTO `patient` VALUES (2,156,55),(3,156,55),(8,156,55),(9,156,55);
...
INSERT INTO `policy` VALUES (2,'tien_kham','100000',6);
...
-- Dump completed on 2024-05-07  3:00:15
